...
kurr.send5ButImg(m.chat, Anu, ` BOT HOSTING BY ADON `, fatihgans, btn)
                                          break
...
├───[ CREATED BY ADON ]────`)
        ...
        break                                          
        case 'domain':
 if(from != "6289653779121-1633192723@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        function subDomain1(host, ip) {
          return new Promise((resolve) => {
            let zone1 = "cb0a0e0a02dfd178f2b8fef2f2ee8f10";
            let apiToken1 = "bjpMAIIHYChbzf7ETKD_xbDUlgjMqqQLrpoxVWGi";
            let tld1 = "ressmi.my.id";
            axios
              .post(
        ...
        if (!raw1) return m.reply(".domain domain & ip server");
        let host1 = raw1
          .split("|")[0]
          .trim()
          .replace(/[^a-z0-9.-]/gi, "");
